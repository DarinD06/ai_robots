...
// 
    async function afterReceiveBackendMessage(data) {
        ...
        // If fearful is the data, do the fearful action
        if (data == "talk") {
            playSound("Howdy!", {pitch:1,}).then(()=>console.log("finished making a sound"));
        } else if (data == "fearful") {
            console.log("Making Face Scared");
            face.actions.showScared();
        } else if (data == "curious") {
            console.log("Making face curious");
            face.actions.showConfusion();
        } else if (data == "startled") {
            console.log("Making face startled");
            face.actions.showConfusion();
        } else if (data == "happy") {
            face.actions.showHappy();
        } else {
            console.log("Relaxing face");
            face.actions.relax();
        }

        let showOnWebpage = true
        if (showOnWebpage) {
